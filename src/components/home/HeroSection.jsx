    ...
    <section className="relative overflow-hidden min-h-screen md:min-h-[85vh] flex items-center">
      ...
      <div className="md:hidden relative z-10 w-full px-4 py-8 text-center">
        ...
        <div className="flex flex-col space-y-3 max-w-xs mx-auto">
          ...
          <button className="bg-white/25 backdrop-blur-xl border border-white/40 text-slate-700 px-6 py-3 rounded-2xl font-semibold shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 text-sm">
      ...
      <div className="hidden md:block relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-start max-w-3xl">
          ...
          <div className="flex flex-row gap-6">
            ...
            <button className="bg-white/25 backdrop-blur-xl border border-white/40 text-slate-700 px-10 py-5 rounded-2xl font-semibold shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 text-lg">
